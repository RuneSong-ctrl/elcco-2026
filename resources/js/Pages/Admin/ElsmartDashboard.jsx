...
const ElsmartDashboard = ({ admin_name, registeredTeams }) => {
    ...
    return (
        <div className="min-h-screen bg-[#0d141c] font-sans relative overflow-hidden text-slate-300">
            <Head title="Admin Dashboard - ELSMART 2026" />
                                    ...
                                    {filteredTeams.map((team, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-5 text-center">
                                                <span
                                                    className={`inline-flex px-3 py-1.5 rounded-md text-[10px] uppercase font-bold ${team.status === "Selesai" ? "bg-frosted-mint-500/10 text-frosted-mint-400 border border-frosted-mint-500/20" : "bg-[#2a3744] text-slate-300"}`}
                                                >
                                                    {team.status}
                                                </span>
                                            </td>
